...
def help(bot, trigger):
    ...
    if trigger.group(2):
        ...
        bot.say("Tässä lista komennoistani {0} - Näet lisää tietoa komennoista "
                "kirjoittamalla {1}apua "
                "<komento> (esmes {1}apua time)".format(url, help_prefix))
...
def help2(bot, trigger):
    response = (
        "Moi, olen botti. Sano {1}komennot niin "
        "näet listan komennoistani. "
        "Minut omistaa {0}."
